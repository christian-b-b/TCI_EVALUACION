package com.tci.evaluacion.constants;
...
public class TciConstants {
    ...
    public static final String RESOURCE_EMPRESA_REGISTRO = "/registro";
    public static final String RESOURCE_EMPRESA_LISTADO = "/listado";
