...
import com.tci.evaluacion.errorhandler.TciGenericServerException;
import com.tci.evaluacion.models.Role;
import com.tci.evaluacion.service.TciDetailService;
...
public class JwtTokenProvider {
  ...
  @Autowired
  private TciDetailService tciDetailService;
  ...
  public String createToken(Object src, List<Role> roles) {
    try {
      ...
      throw new TciGenericServerException("Error during parse text for JWT");
    }
  }
  ...
  public boolean validateToken(String token) {
    try {
      ...
      throw new TciGenericClientException("Expired or invalid JWT token",
  ...
  public Authentication getAuthentication(String token) throws JsonProcessingException {
    UserDetails userDetails = tciDetailService.loadUserByUsername(getUsername(token));
